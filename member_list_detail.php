    ...
    <table class="table table-striped table-bordered" style="table-layout:auto;">
        <thead>
            <tr>
                ...
                <th scope="col">生日</th>
                <th scope="col">個人照</th>
                <th scope="col">打卡資訊</th>
                <th scope="col">信用卡號</th>
                <th scope="col">會員收藏</th>
                <th scope="col">每日抽獎與否</th>
        ...
        <tbody>
            <?php foreach ($rows as $r) : ?>
                <tr>
                    ...
                    <td><?= $r['member_coupon'] ?></td>
                    <td><?= $r['member_mobile'] ?></td>
                    <td><?= $r['member_address'] ?></td>
                    <td><?= $r['member_email'] ?></td>
                    <td><?= $r['member_birthday'] ?></td>
                    <td><?= $r['member_photo_img_path'] ?></td>
                    <td><?= $r['member_everyday_login_record'] ?></td>
                    <td><?= $r['member_creditcard_number'] ?></td>
                    <td><?= $r['member_shares'] ?></td>
                    <td><?= $r['member_lottery_by_day'] ?></td>
                    <td><?= $r['member_ceate_date'] ?></td>
                </tr>
            <?php endforeach; ?>
